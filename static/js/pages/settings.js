  ...
  container.innerHTML = `
    ...
    <div style="max-width:640px;display:flex;flex-direction:column;gap:18px">
      ...
      <div class="card">
        ...
        <div style="display:flex;align-items:center;gap:14px;flex-wrap:wrap">
          ...
          <div style="flex:1;min-width:160px">
            <div style="font-weight:600;font-size:14px;color:var(--txt-1);overflow:hidden;text-overflow:ellipsis">${user?.email || 'Student Account'}</div>
      ...
      <div class="card">
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding-top:10px;border-top:1px solid var(--line-1)">
          <div>
